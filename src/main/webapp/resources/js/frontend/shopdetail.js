$(function() {
	...
	var pageSize = 3;
	// 列出商品列表的URL
	var listUrl = '/o2oDemo/frontend/listproductsbyshop';
	// 默认的页码
	var pageNum = 1;
	// 从地址栏里获取ShopId
	...
	var searchDivUrl = '/o2oDemo/frontend/listshopdetailpageinfo?shopId=' + shopId;
	...
	// $('#exchangelist').attr('href', '/o2oDemo/frontend/awardlist?shopId=' +
	// shopId);
	// 获取本店铺信息以及商品类别信息列表
